...
#define SCK_PORT GPIOA//时钟信号
#define SCK_PIN GPIO_Pin_5
#define MOSI_PORT GPIOA//数据信号SDA
...
static void lcd_spi_gpio_init(void)
{
    ...
    GPIO_WriteBit(SCK_PORT, SCK_PIN, Bit_SET);  /* idle时候为高电平 */
    ...
    GPIO_WriteBit(MOSI_PORT, MOSI_PIN, Bit_SET);  /* idle时候为高电平 */
